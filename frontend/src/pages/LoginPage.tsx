    ...
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-watt-green-950/30 via-background to-background px-4">
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="rounded-2xl border border-border bg-card p-8 shadow-xl">
          ...
          <div className="mb-8 flex flex-col items-center">
            ...
            <p className="mt-2 text-center text-sm text-muted-foreground">
              Sign in to monitor classroom energy usage and reduce waste.
            </p>
          </div>
          ...
          <div className="mt-6 text-center">
            <p className="text-xs text-muted-foreground">
              By signing in, you agree to use this prototype for demonstration
              purposes only.
            </p>
          </div>
        </div>
        ...
        <p className="mt-6 text-center text-xs text-muted-foreground">
          Microsoft 1M1B Showcase Project — WattWise AI
        </p>
      </div>
    </div>
  );
